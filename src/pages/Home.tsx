...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center pl-6 max-w-29/30 mb-5 lg:px-12 py-3 min-h-dvh md:flex-1 md:min-h-0">
      ...
      <div className="h-full border-3 border-blue-900 rounded-lg bg-linear-to-r from-blue-300 via-blue-100 to-white shadow-[-20px_0_70px_rgba(0,0,0,0.4)] flex flex-col sm:hidden">
