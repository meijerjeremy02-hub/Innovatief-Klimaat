...
export default function Vragen2() {
  return (
    <div className="flex rounded-lg flex-col border-2 mx-auto max-w-300">
      <VraagRij tekst="1. Ideeën worden niet snel afgewezen." />
      <VraagRij tekst="2. Collega's luisteren met interesse naar nieuwe voorstellen." />
      <VraagRij tekst="3. Er is een constructieve houding tegenover verandering." />
      <VraagRij tekst="4. Ideeën worden vaak verder ontwikkeld door anderen." />
      <VraagRij tekst="5. Leidinggevenden staan open voor creatieve voorstellen." />
    </div>
  )
}