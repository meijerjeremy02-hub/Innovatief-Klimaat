...
export default function Vragen7() {
  return (
    <div className="flex rounded-lg flex-col border-2 mx-auto max-w-300">
      <VraagRij tekst="1. Ik durf dingen te proberen zonder zekerheid." />
      <VraagRij tekst="2. Experimenteren wordt aangemoedigd." />
      <VraagRij tekst="3. Fouten maken is acceptabel." />
      <VraagRij tekst="4. Nieuwe ideeën worden snel getest." />
      <VraagRij tekst="5. Het team neemt bewust risico's om te leren." />
    </div>
  )
}