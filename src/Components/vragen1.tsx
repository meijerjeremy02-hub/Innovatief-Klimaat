...
export default function Vragen1() {
  return (
    <div className="flex rounded-lg flex-col border-2 mx-auto max-w-300">
      <VraagRij tekst="1. Ik beslis zelf hoe ik mijn werk aanpak." />
      <VraagRij tekst="2. Ik heb ruimte om nieuwe ideeën uit te proberen." />
      <VraagRij tekst="3. Procedurele regels beperken ons niet overdreven." />
      <VraagRij tekst="4. Ik kan alternatieve manieren van werken verkennen." />
      <VraagRij tekst="5. Ik kan mijn eigen tijd grotendeels zelf indelen." />
    </div>
  )
}