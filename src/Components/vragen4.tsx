...
export default function Vragen4() {
  return (
    <div className="flex rounded-lg flex-col border-2 mx-auto max-w-300">
      <VraagRij tekst="1. Er gebeurt veel in onze organisatie." />
      <VraagRij tekst="2. Het team bruist van de energie." />
      <VraagRij tekst="3. Nieuwe kansen en ideeën ontstaan regelmatig." />
      <VraagRij tekst="4. Plannen veranderen snel wanneer dat nodig is." />
      <VraagRij tekst="5. Er is een levendige, actieve sfeer." />
    </div>
  )
}