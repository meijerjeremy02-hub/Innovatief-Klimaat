...
export default function Vragen8() {
  return (
    <div className="flex rounded-lg flex-col border-2 mx-auto max-w-300">
      <VraagRij tekst="1. Ik heb tijd om aan nieuwe ideeën te werken." />
      <VraagRij tekst="2. We plannen regelmatig momenten voor reflectie." />
      <VraagRij tekst="3. Creatieve ideeën krijgen aandacht, ook als het druk is." />
      <VraagRij tekst="4. Er is ruimte om te onderzoeken en te experimenteren." />
      <VraagRij tekst="5. We maken tijd vrij om ideeën verder vorm te geven." />
    </div>
  )
}